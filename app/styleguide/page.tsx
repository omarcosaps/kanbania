...
export default function StyleguidePage() {
  return (
    <div className="p-8 md:p-12">
      ...
      <Section
        title="Tipografia"
        description="Inter — escala Figma de 8 tamanhos (12px–36px), mapeada para text-xs até text-4xl."
      >
        <TypeScaleDemo />
      </Section>
      ...
      <Section
        title="Border radius"
        description="Escala Figma — sm 4px, md 8px, lg 12px, xl 24px."
      >
        <RadiusDemo />
      </Section>

      <Section title="Sombras" description="Sombra padrão dos cards de tarefa.">
        <ShadowDemo />
      </Section>
    </div>
  );
